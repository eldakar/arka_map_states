arka_map_states = arka_map_states or {
  ...
  function ateam:print_obj_team(id, obj)
    ...
    if obj then
        ...
        local str_name = "<reset>[<LightSlateBlue>" .. states_fatigue[scripts.character.state["fatigue"]] .. "<reset>]"
  ...
  function arka_map_states:missing_members()
    local not_here = {}
    ...
    for k, v in pairs(ateam.team) do
        if type(v) == "number" and table_has_value(gmcp.objects.nums, v) == false then
            arka_map_states:append("<black:team_console_bg>----------<grey>[---?---] " .. ateam.objs[v]["desc"] .. "\n")
            --arka_map_states.cnt_t = arka_map_states.cnt_t + 1
        end
    end
end
  ...
  function arka_map_states:label_states()
    arka_map_states:missing_members()
  ...
  function arka_map_states:popup_enemy_font_adjustment()
      ...
      testlabell:setColor(20,20,20, 0)
      self:fake()
  end
  ...
  function arka_map_states:resize_fonts()
      ...
      if cnt_e ~= self.cnt_e then
          setLabelStyleSheet("testlabell",arka_map_states_font_team[100][cnt_e])
          --testlabell:setColor(40,20,20, 230)
          testlabell:setColor(20,20,20, 0)
  ...
  function arka_map_states:fake()
    ...
    -- preconf
    --scripts.ui.footer_height = 110
    --scripts.ui.footer_info_width_p = 0
    --scripts.ui.footer_map_font_size = 12
    --/lua amap.ui.compass.button_center:echo(scripts.ui.footer_info_sneaky.message)
    --amap.walk_mode
    --/lua amap.ui.compass.button_center:echo("<center>👪</center>")
    ...
    scripts.ui["footer_info_walk_mode_to_text"] = {
        "<font color='" .. scripts.ui["footer_info_neutral"] .. "'><center>+</center></font>",
        "<font color='" .. scripts.ui["footer_info_green"] .. "'><center>JA</center></font>",
        "<font color='" .. scripts.ui["footer_info_red"] .. "'><center>MY</center></font>"
    }
    --
    -- walking
    --
    function scripts_ui_info_sneaky_click(id)
        if id and type(id) == "number" then
            ...
            amap.walk_mode = id
            amap.ui.compass.button_center:echo(scripts.ui["footer_info_walk_mode_to_text"][amap.walk_mode])
        else
